...
We plan to add budget data for Benicia, Dixon, Suisun City, and Rio Vista as those cities publish their FY2025 adopted budgets. We're also building a [Public Funds Tracker](/public-funds/) that will make this data interactive and include historical trends.

If you have access to budget documents we're missing, or if you spot an error in this data, please [let us know](mailto:ryan@civic.studio?subject=Budget Data Feedback).

*Data sourced from adopted budget documents published by each city's finance department. Population figures from California Department of Finance 2025 estimates. See the [datasets page](/public-funds/) for more detail on methodology and sources.*
